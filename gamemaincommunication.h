...
//extern BOOL cfgmc_altenative[3];	// 選択肢を選択
#pragma endregion
...
//extern int commu_character_visibility_count;	// キャラクター不透明度切り替えが完了するまでのフレーム数
#pragma endregion
...
#pragma region ver0.007制作時コメント化コード
//extern float commu_altenative_x[3];					// 選択肢x座標
#pragma endregion
#pragma region ver0.00704制作時コメント化コード
//extern float commu_altenative_y_upper;				// 上側選択肢y座標
//extern float commu_altenative_y_under;				// 下側選択肢y座標
#pragma endregion
...
//void GameMainCommunicationNext(int x);				// コミュ画面移行処理
#pragma endregion
#pragma region ver0.00607制作時コメント化コード
//void GameMainCommunicationNext(int x, BOOL y);		// コミュ画面移行処理
#pragma endregion
...
//int DrawGameMainCommunicationMouseAnimation();		// 描画する口パクの画像を判別する
#pragma endregion
